...
This document is a draft. The following are unresolved:
...
We do not need to answer all of these before building. Some answers will only become clear by trying things. Others may resolve themselves once we see how users actually use the system.
